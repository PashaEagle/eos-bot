...
@Service(value = AdminItemKeyboard.BEAN_NAME)
@Scope(value = BeanDefinition.SCOPE_PROTOTYPE)
public class AdminItemKeyboard extends BaseReplyKeyboard {

	public static final String BEAN_NAME = "AdminItemKeyboard";
