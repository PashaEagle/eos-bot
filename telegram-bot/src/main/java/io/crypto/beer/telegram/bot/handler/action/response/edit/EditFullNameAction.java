...
@Service(value = EditFullNameAction.BEAN_NAME)
@Scope(value = BeanDefinition.SCOPE_PROTOTYPE)
public class EditFullNameAction extends BaseResponseAction {

    public static final String BEAN_NAME = "editFullNameAction";

    private final Bot bot;

    public EditFullNameAction(ApplicationContext ctx, Bot bot) {
        super(ctx, bot);
        this.bot = bot;
    }
    ...
    protected void makeAction(Update update) {
        bot.getSession(update).getEditState().clickProfileFullName();
    }
