...
public class ProfileFullNameEditCommand implements ICommandResponse {
    ...
    public boolean check(Update update) {
        return bot.getSession(update).getEditState().isProfileFullName();
    }
