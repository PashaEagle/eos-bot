...
public class ProfileAddressStreetEditCommand implements ICommandResponse {
    ...
    public boolean check(Update update) {
        ...
        return session.getEditState().isAddressStreet() && session.getEditState().getNumberOfAddress() != null;
    }
