...
@Service(value = AdminBreweryKeyboard.BEAN_NAME)
@Scope(value = BeanDefinition.SCOPE_PROTOTYPE)
public class AdminBreweryKeyboard extends BaseReplyKeyboard {

	public static final String BEAN_NAME = "AdminBreweryKeyboard";
