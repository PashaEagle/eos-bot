...
@Service(value = AddressAddKeyboard.BEAN_NAME)
@Scope(value = BeanDefinition.SCOPE_PROTOTYPE)
public class AddressAddKeyboard extends BaseReplyKeyboard {

	public static final String BEAN_NAME = "addressAddKeyboard";
